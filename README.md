<div align="center">
  ...
  <img src="https://raw.githubusercontent.com/svetikbukh-netizen/svetikbukh-netizen/main/pngtree-3d-data-analytics-dashboard-with-rising-graph-on-transparent-background-png-image_19088845.jpg" alt="3D дашборд с графиками" width="300px"/>
  
  <h2>Привет, меня зовут Светлана!👋 </h2>

</div>

Я — Аналитик Данных и BI-аналитик. Моя главная задача — делать данные понятными, чтобы бизнес мог принимать правильные решения. Я считаю, что хороший отчет — это не просто цифры, а четкое руководство к действию. Мне нравится работать с большими массивами информации, чтобы находить в них то, что действительно важно для компании.

Я — Опытный специалист с общей карьерой более 12 лет в крупном банке. Этот путь научил меня быть внимательной к деталям и отлично понимать, как устроены бизнес-процессы. При этом последний год моей работы был полностью сфокусирован на аналитике: я разрабатывала и строила аналитическую отчетность, составляя витрины данных внутри DWH (SQL, Oracle). Теперь я объединяю эту мощную базу данных и бизнес-процессов с современными навыками в Python и A/B-тестировании. Я готова использовать этот комплексный опыт, чтобы решать сложные аналитические задачи и помогать вашей команде расти.

Ищу позицию Аналитика Данных или BI-аналитика с возможностью удаленной работы, где смогу применить свой комплексный опыт работы с SQL, данными и бизнесом.

<div align="center">
  
  ### ✉️ Свяжитесь со мной
  <p>Я открыта для новых возможностей и всегда готова обсудить интересные аналитические задачи:</p>
  
  [![Telegram](https://img.shields.io/badge/Telegram%20%40sveto4ei-27A7E7?style=for-the-badge&logo=telegram)](https://t.me/sveto4ei)
  [![WhatsApp +375336314522](https://img.shields.io/badge/-WHATSAPP-28D146?style=for-the-badge&logo=whatsapp&logoColor=FFFFFF)](https://wa.me/375336314522)
  [![Email svetik.bukh@gmail.com](https://img.shields.io/badge/Email%20svetik.bukh%40gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=FFFFFF)](mailto:svetik.bukh@gmail.com)

</div>


### 🛠️ Ключевые Технологии и Навыки
...
[![Oracle](https://img.shields.io/badge/Oracle-F80000?style=for-the-badge&logo=oracle&logoColor=white)](https://docs.oracle.com/)
...
[![DataLens](https://img.shields.io/badge/Yandex_DataLens-FFD54F?style=for-the-badge&logo=yandex&logoColor=black)](https://datalens.tech/)
...
* [BI - аналитик - TeachMeSkills](https://drive.google.com/file/d/175kZStKkEQ4mE8FdP4Yz0lj57sMuZtOp/view?usp=sharing)
* [Симулятор SQL - `Karpov.Courses`](https://lab.karpov.courses/certificate/2722093e-e3af-488a-8d8c-c3368d84f32a/)
* [Аналитик данных - `Karpov.Courses`](https://lab.karpov.courses/certificate/0fca4830-95fb-45cb-8ecf-5f0fdf7702c2/)

### 🧑‍💻 Проекты:

Здесь представлены примеры моих проектов, демонстрирующие навыки работы со статистикой, SQL-оптимизацией и решением бизнес-задач.

</div>

| Название проекта | Цель и Задача | Стек и Методы | Ключевой Результат | Ссылка |
| :--- | :--- | :--- | :--- | :--- |
| **Анализ эффективности платежной системы** | Оценить влияние новой механики оплаты на ключевые метрики (CR, ARPU, ARPPU) и дать обоснованную рекомендацию. | Python (Pandas), SQL, A/B-тестирование, Бутстрап, Z-тест. | Выявлен статистически значимый рост среднего чека (ARPPU). | [GitHub 🔗](https://github.com/svetikbukh-netizen/data-analysis-project) |
| **SQL-анализ активности студентов** | Оценить вовлеченность студентов и проанализировать эффективность A/B-теста нового экрана оплаты. | PostgreSQL, SQL (Window Functions, CTE, SUM CASE). | Проведена точная оценка 'усердия' студентов и определено влияние нового экрана оплаты на метрики. | [GitHub 🔗](https://github.com/svetikbukh-netizen/data-analysis-project_sql) |
| **Автоматизация учета кредитных досье (Кейс из опыта)** | Оптимизировать сбор и структурирования данных по кредитной задолженности. | MS Excel. | Сокращено время обработки данных на ≈25% за счет перехода с бумажного на электронный учет. | *Из опыта работы* |
...
<p align="center">
    <a href="https://github.com/svetikbukh-netizen">
        <img src="https://github-readme-stats.vercel.app/api?username=svetikbukh-netizen&show_icons=true&theme=buefy&hide_border=true&include_all_commits=true" alt="GitHub Stats">
    </a>
</p>

<p align="center">
    <a href="https://github.com/svetikbukh-netizen">
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=svetikbukh-netizen&layout=compact&theme=buefy&hide_border=true" alt="Top Languages">
    </a>
</p>

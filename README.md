...
Я BI-аналитик и `Разработчик аналитической отчетности` с более чем 12-летним опытом в финансовом секторе, специализируюсь на DWH, SQL (Oracle, PL/SQL) и формализации бизнес-требований. Моя основная цель — трансформировать сложные сырые данные в актуальные и обоснованные бизнес-решения для топ-менеджмента, обеспечивая точность и высокое качество данных.
Я непрерывно инвестирую в свое развитие, успешно освоив Python (Pandas, NumPy) и A/B-тестирование на углубленном курсе от \`Karpov.Courses\`. Многолетний опыт в банковской сфере обеспечил мне сильные Soft Skills (развитые коммуникативные навыки, инициативность и дисциплина), которые я эффективно применяю для успешной командной работы и решения сложных аналитических задач.

...
<h3 align="center">
  📊 Аналитик Данных | \`BI\`-Аналитик | Эксперт по SQL (DWH)
</h3>

### 🎯
* **📊 Роль:** BI-аналитик с **12+ годами опыта в финансах**. Фокус: **DWH:Data Warehouse** и отчетность.
* **🛠️ Навыки:** Владение **SQL (Oracle, PL/SQL)**. Опыт создания **витрин данных** и аналитики.
* **💡 Результат:** Превращение данных в **бизнес-аналитику** для принятия **решений**.
* **🚀 Развитие:** Дополнительный опыт работы с **Python** и **A/B-тестированием**.
* **🤝 Команда:** Развитые **Soft Skills** и инициативность.
...
Здесь представлены примеры моих проектов, демонстрирующие навыки работы со статистикой, SQL-оптимизацией и решением бизнес-задач, полученные в рамках углубленной программы обучения.

#### 1. Анализ эффективности новой платежной системы и оптимизация конверсии
* **Стек:** Python (Pandas, Matplotlib, Seaborn), **A/B-тестирование (Бутстрап, Z-тест)**.
* **Результат:** Выявлен статистически значимый рост среднего чека платящих пользователей (ARPPU).
* **[🔗 Посмотреть код проекта](https://github.com/svetikbukh-netizen/data-analysis-project)**

#### 2. Анализ активности и конверсии студентов (SQL-аналитика)
* **Стек:** **PostgreSQL, Оптимизированный SQL** (Window Functions, CTE, Conditional Aggregation).
* **Ключевой результат:** Проведена точная 'оценка' 'вовлеченности' студентов и определено влияние нового экрана оплаты на метрики ARPU, ARPAU и CR.
* **[🔗 Посмотреть код проекта](https://github.com/svetikbukh-netizen/data-analysis-project_sql)**
